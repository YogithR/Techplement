...
#     contact_fields =["Name ", "Mobile Number "]
...
#             self.contact_data = []
#             print("")
#             print("Contact is created sucessfully".center(129))
#             print("\n")
...
#     print("2. Add New Contact".center(128))
#     print("3. Search Contact".center(128))
#     print("4. Delet A Contact".center(128))
#     print("5. Exit Contacts".center(128))
#     print("------------------------------".center(131))
...
class contact_functions:
    ...
    def create(self):
        # Reset contact data for each contact creation
        self.contact_data = []
...
# Instantiate the contact_functions class
...
if option == 2:
    ...
    # Clear the console after finishing
    if os.name == 'nt':  # Windows
        os.system('cls')
    else:  # Unix-based systems
        os.system('clear')
